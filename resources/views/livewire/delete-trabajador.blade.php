<div>
    ...
    <div class="flex justify-center p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg" role="alert"
        ...
        <div>
            <span class="font-medium">VAS A PROCEDER AL BORRADOR DEL TRABAJADOR Y SUS UNIFORMIDADES DEL SISTEMA.
                CONTINUA SÓLO SI ESTÁS SEGURO.</span> {{ session('uniformidadAddedToWorker') }}
        </div>
    </div>
                    ...
                    <tbody class="bg-white">
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 font-semibold border text-ms">
                                <button type="button" wire:click="delete( {{ $trabajador->id }})"

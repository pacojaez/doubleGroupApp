        ...
        <div class="container mt-4">
            ...
            @if (count($errors) > 0)
                <div class="alert alert-danger">
                    <strong>Whoops!</strong> Hay algún error con esos datos.<br><br>
                    <ul>
            ...
            <form method="POST" action="{{ route('roles.update', $role->id) }}">
                ...
                <label for="permissions" class="form-label">Asignación de Permisos</label>

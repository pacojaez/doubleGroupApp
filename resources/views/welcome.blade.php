...
<head>
    ...
    <style>
        ...
        *,
        ...
        .bg-image {
            /* The image used */
            background-image: url('https://doublegroupuniformidades.pjrphotography.es/storage/img/doublegroup1.jpeg');
...
<body class="antialiased">
    <div
        ...
        <div>
            <div
                class="relative p-12 mx-auto overflow-hidden text-center bg-no-repeat bg-cover rounded-lg max-w-7xl lg:p-8">
                <div class="flex justify-center">
                    <img src="{{ asset('storage/img/Logo.png') }}" alt="Double Grup Logo">
                </div>
                <div class="p-6 mt-16 bg-text">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div class="flex flex-row items-center justify-start">
                                    ...
                                    <h2 class="mt-2 text-xl font-semibold text-gray-900">GESTIÓN DE UNIFORMIDADES</h2>
                                </div>
                                <p class="mt-4 text-base leading-relaxed text-gray-500">
                                    Aplicación para la Gestión y el Control de Uniformidades.
                                </p>
                            </div>
                        </div>
                                    ...
                                    <div class="z-10 p-2">
                                        @auth
                                            <a href="{{ url('/dashboard') }}"
                                                class="font-semibold text-gray-600 hover:text-red-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                                <button
                                        ...
                                        @else
                                            <a href="{{ route('login') }}"
                                                class="font-semibold text-gray-600 hover:text-red-900 hover:font-bold hover:underline focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                                <button
                                                    class="px-5 py-3 mb-3 text-base font-medium text-white transition duration-200 bg-blue-500 rounded-full hover:bg-blue-600 active:bg-blue-700">
                                                    LOG IN
                                                </button>
                    ...
                    <div class="text-sm text-center text-gray-500 sm:text-left">
                        <div class="flex items-center gap-4">
                            <a href="https://github.com/sponsors/taylorotwell"
                                class="inline-flex items-center group hover:text-gray-700 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5"
                                    class="w-5 h-5 mr-1 -mt-px stroke-gray-400 group-hover:stroke-gray-600">
                                    <path stroke-linecap="round" stroke-linejoin="round"
